...
c      end if
      ...
      call tmxmx_shpg(lag,nte,nec,idp,pe(1,1,ip),nte,idp,
     1          ze(1,1,ip),xe,ye,ipse(1,ip),jzse(1,ip))  
      ...
      call tmxmx_shpg(lag,nte,nem,idp,pe(1,nec+1,ip),nte,idp,
     1ze(1,nec+1,ip),xe,ye,ipse(nec+1,ip),jzse(nec+1,ip))
      end if
      if(3*noc.lt.2*nom.or.nom.eq.0) then
      call tmxmx_shpg(lag,nto,noc,idp,po(1,1,ip),nto,idp,
     1          zo(1,1,ip),xo,yo,ipso(1,ip),jzso(1,ip))
      ...
      call tmxmx_shpg(lag,nto,nom,idp,po(1,noc+1,ip),nto,idp,
...
c
      ...
      subroutine tmxmx_shpg(lag,lr,lc,ld,a,mc,md,b,x,y,is,js)
